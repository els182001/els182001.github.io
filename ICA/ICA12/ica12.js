...
//how many ball do we want?
while (balls.length <100) {
    const size = random(1, 30); //determining hypothetical smallest and largest ball
    const ball = new Ball(
        random(0 + size, width - size), //random posittion
        random(0 + size, height - size), //random position
        random(-10, 10), //random speed x
        random(-10,10), // random speed y
        randomRGB(),
        size
    );
